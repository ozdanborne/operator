...
func handleCore(c *components, install *Installation) error {
	...
	if c.kubeControllers != nil {
		...
		enabledControllers, err := c.kubeControllers.getEnv(ctx, c.client, containerKubeControllers, "ENABLED_CONTROLLERS")
		if err != nil {
			return err
		}
		...
		// auto heps
		autoHeps, err := c.kubeControllers.getEnv(ctx, c.client, containerKubeControllers, "AUTO_HOST_ENDPOINTS")
		if err != nil {
			return err
		}
